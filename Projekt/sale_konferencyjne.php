...
<head>
    ...
    <!-- Title -->
    <title>Sale konfenrencyjne</title>
...
<body>
    <div class="MAIN">
        ...
        <div class="Main_Page">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10">
                        ...
                        <div class="Title_of_Page">Sale konfenrencyjne</div>
                            ...
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS//Sale_konferencyjne/salakonf1.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Sala konfenrencyjna duża, B4 s.231</b> </div></br>
                                        <div class="Number"><b>Maksymalna ilosc miejsc:</b> 200</div></br>
                    ...
                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="row justify-content-center">
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS//Sale_konferencyjne/salakonf2.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Sala konfenrencyjna, B1 s.142</b> </div></br>
                    ...
                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS//Sale_konferencyjne/salakonf3.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Sala konfenrencyjna, B1 s.178</b> </div></br>
                                        <div class="Number"><b>Maksymalna ilosc miejsc:</b> 110</div></br>
                                        <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                            Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque
                                            porta pulvinar libero
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 SameBackground">
                        <br>
                        <div class="row justify-content-center">
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS//Sale_konferencyjne/salakonf4.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Sala konfenrencyjna, B3 s.190</b> </div></br>
                                        <div class="Number"><b>Maksymalna ilosc miejsc:</b> 140</div></br>
                                        <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                            Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque
                                            porta pulvinar libero
                    ...
                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS//Sale_konferencyjne/salakonf5.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Sala konfenrencyjna mała, B2 s.140</b> </div></br>
                                        <div class="Number"><b>Maksymalna ilosc miejsc:</b> 80</div></br>
                                        <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                            Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque
                                            porta pulvinar libero
