        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10">
                    ...
                    <div class="Title_of_Page">Duże aule</div>
                        ...
                        <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                            <div class="row">
                                ...
                                <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="Subtitle"><b>Aula A3 im. Lorem ipsum</b> </div></br>
                                    <div class="Number"><b>Maksymalna ilosc miejsc:</b> 270</div></br>
                                    <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque porta pulvinar libero
                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="row justify-content-center">
                        <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                            <div class="row">
                                <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                    <img src="./CSS/Duze aule/duzaaula2.jpg" class="IMG" />
                                </div>
                                <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    </br>
                                    <div class="Subtitle"><b>Aula F1 im. Lorem ipsum</b> </div></br>
                                    <div class="Number"><b>Maksymalna ilosc miejsc:</b> 300</div></br>
                                    <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque porta pulvinar libero
                                        et eget justo eu. Venenatis vel penatibus mauris gravida sed eget.
                                    </div>
                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                            <div class="row">
                                <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                    <img src="./CSS/Duze aule/duzaaula3.jpg" class="IMG" />
                                </div>
                                <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    </br>
                                    <div class="Subtitle"><b>Aula B23 im. Lorem ipsum</b> </div></br>
                                    <div class="Number"><b>Maksymalna ilosc miejsc:</b> 250</div></br>
                                    <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque porta pulvinar libero
                                        et eget justo eu. Venenatis vel penatibus mauris gravida sed eget.
                                    </div>
                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="row justify-content-center">
                        <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                            <div class="row">
                                <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                    <img src="./CSS/Duze aule/duzaaula4.jpg" class="IMG" />
                                </div>
                                <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                    </br>
                                    <div class="Subtitle"><b>Aula B5 im. Lorem ipsum</b> </div></br>
                                    <div class="Number"><b>Maksymalna ilosc miejsc:</b> 300</div></br>
                                    <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque porta pulvinar libero
                                        et eget justo eu. Venenatis vel penatibus mauris gravida sed eget.
