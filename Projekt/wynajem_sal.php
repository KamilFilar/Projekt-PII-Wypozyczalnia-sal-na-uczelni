...
<head>
    ...
    <link rel="stylesheet" href="CSS/wynajem_sal.css">
    <!-- Bootsrap -->
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10">
                        <div class="Title_of_Page">Wykaz sal</div>
                        <div class="Links Links7"></div>
                        <div class="Links Links8"></div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 OptionPlace">
                        <div class="row justify-content-center">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <a href="./duze_aule.php"><img src="./CSS/Wynajem_sal/duzaaula1.jpg" class="IMG" />
                                    <div class="SubTitle">Duże aule</div>
                                </a>
                            </div>
                            <div class="col col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 borderinfo">
                                <div class="Number_of_persons">Liczba osób: <b class="color">200-300</b></div>
                                <div class="Number_of_rooms">Ilość pomieszczeń: <b class="color">4</b></div>
                            </div>
                            <div class="col col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 my-auto">
                                <div class="text-center" style="padding-top: 10px;">
                                    <a href="./duze_aule.php" style="text-decoration: none;"><button type="button" class="Button_Gutgut"><b class="text_button">Więcej</b></button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12"></div>
                    <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 OptionPlace">
                        <div class="row justify-content-center">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <a href="./sale_konferencyjne.php"><img src="./CSS/Wynajem_sal/salakonf5.jpg" class="IMG" />
                                    <div class="SubTitle">Sale konferencyjne</div>
                                </a>
                            </div>
                            <div class="col col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 borderinfo">
                                <div class="Number_of_persons">Liczba osób: <b class="color">150-200</b></div>
                                <div class="Number_of_rooms">Ilość pomieszczeń: <b class="color">5</b></div>
                            </div>
                            <div class="col col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 my-auto">
                                <div class="text-center" style="padding-top: 10px;">
                                    <a href="./sale_konferencyjne.php" style="text-decoration: none;"><button type="button" class="Button_Gutgut"><b class="text_button">Więcej</b></button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center SameBackground">
                    <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 OptionPlace">
                        <div class="row justify-content-center">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <a href="./pracownie_komputerowe.php"><img src="./CSS/Wynajem_sal/komp.jpg" class="IMG" />
                                    <div class="SubTitle">Pracownie komputerowe</div>
                                </a>
                            </div>
                            <div class="col col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 borderinfo">
                                <div class="Number_of_persons">Liczba osób: <b class="color">15-30</b></div>
                                <div class="Number_of_rooms">Ilość pomieszczeń: <b class="color">3</b></div>
                            </div>
                            <div class="col col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 my-auto">
                                <div class="text-center" style="padding-top: 10px;">
                                    <a href="./pracownie_komputerowe.php" style="text-decoration: none;"><button type="button" class="Button_Gutgut"><b class="text_button">Więcej</b></button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 OptionPlace">
                        <div class="row justify-content-center">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <a href="./aule.php"><img src="./CSS/Wynajem_sal/malaaula.jpg" class="IMG" />
                                    <div class="SubTitle">Aule</div>
                                </a>
                            </div>
                            <div class="col col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 borderinfo">
                                <div class="Number_of_persons">Liczba osób: <b class="color">100-150</b></div>
                                <div class="Number_of_rooms">Ilość pomieszczeń: <b class="color">6</b></div>
                            </div>
                            <div class="col col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 my-auto">
                                <div class="text-center" style="padding-top: 10px;">
                                    <a href="./aule.php" style="text-decoration: none;"><button type="button" class="Button_Gutgut"><b class="text_button">Więcej</b></button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 OptionPlace">
                        <div class="row justify-content-center">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <a href="./sale_sportowe.php"><img src="./CSS/Wynajem_sal/gimnastyczna.jpg" class="IMG" />
                                    <div class="SubTitle">Sale sportowe</div>
                                </a>
                            </div>
                            <div class="col col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 borderinfo">
                                <div class="Number_of_persons">Liczba osób: <b class="color">30</b></div>
                                <div class="Number_of_rooms">Ilość pomieszczeń: <b class="color">3</b></div>
                            </div>
                            <div class="col col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 my-auto">
                                <div class="text-center" style="padding-top: 10px;">
                                    <a href="./sale_sportowe.php" style="text-decoration: none;"><button type="button" class="Button_Gutgut"><b class="text_button">Więcej</b></button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 OptionPlace">
                        <div class="row justify-content-center">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <a href="./pozostale.php"><img src="./CSS/Wynajem_sal/muz.jpg" class="IMG" />
                                    <div class="SubTitle">Pozostałe</div>
                                </a>
                            </div>
                            <div class="col col-xl-7 col-lg-12 col-md-12 col-sm-12 col-12 borderinfo">
                                <div class="Number_of_persons">Liczba osób: <b class="color">25-300</b></div>
                                <div class="Number_of_rooms">Ilość pomieszczeń: <b class="color">3</b></div>
                            </div>
                            <div class="col col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 my-auto">
                                <div class="text-center" style="padding-top: 10px;">
                                    <a href="./pozostale.php" style="text-decoration: none;">
                                        <button type="button" class="Button_Gutgut"><b class="text_button">Więcej</b></button>
                                    </a>
                                </div>
                            </div>
                        </div>
