...
<body>
    ...
    <div class="MAIN">
                    ...
                    <div class="col col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="showacc">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                                    <input type="text" id="status" name="status" value="Student" class="inputtext" disabled>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                                    <input type="text" id="loginadmina" name="loginadmina" value="Login użytkownika" class="inputtext" disabled>
                                </div>

                            </div>
                            <div class="center_button" style="margin-top: 50px;">
                                <button type="button" class="CoolButton" onclick="location.href='edycja_konta_uzytkownik.php';">Edytuj</button>
                            </div><br>
                        </div>
                        <br><br>
                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="SameBackground">
                <div class="row justify-content-center ">
                    <div class="col col-xl-9 col-lg-10 col-md-11 col-sm-11 col-11">
                        <div class="yourloans">
                            <div class="Title_of_Page">Twoje wypożyczenia
                                <div class="Links Links7"></div>
                                <div class="Links Links8"></div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="border: 2px solid  rgb(0, 42, 78)">Data</th>
                                            <th scope="col" style="border: 2px solid  rgb(0, 42, 78)">Nazwa pomieszczenia</th>
                                            <th scope="col" style="border: 2px solid  rgb(0, 42, 78)">Typ pomieszczenia</th>
                                            <th scope="col" style="border: 2px solid  rgb(0, 42, 78)">Płatność</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td scope="row">19.10.2020<br>
                                                <div class="hours">12:00-13:30</div>
                                            </td>
                                            <td>Aula A3 im. Lorem ipsum</td>
                                            <td>Duża aula</td>
                                            <td>Dokonano</td>
                                        </tr>
                                        <tr>
