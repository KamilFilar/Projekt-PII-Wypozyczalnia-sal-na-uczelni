        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10">
                    ...
                    <div class="Title_of_Page">Sale sportowe</div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                            <div class="row">
                                ...
                                <img src="./CSS/Sale sportowe/sala_gim.jpg" class="IMG" />
                            </div>
                            <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                </br>
                                <div class="Subtitle"><b>Hala, G1 s.1</b> </div></br>
                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="row justify-content-center">
                        <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                            <div class="row">
                                <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                <img src="./CSS/Sale sportowe/gimnastyczna2.jpg" class="IMG" />
                            </div>
                            <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                </br>
                                <div class="Subtitle"><b>Hala im. Lorem sportowca, G1 s.2</b> </div></br>
                ...
                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                            <div class="row">
                                <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                <img src="./CSS/Sale sportowe/gimnastyczna.jpg" class="IMG" />
                            </div>
                            <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                </br>
                                <div class="Subtitle"><b>Sala gimnastyczna, G1 s.5</b> </div></br>
                                <div class="Number"><b>Maksymalna ilosc miejsc:</b> 35 </div></br>
                                <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing
                                    elit.
                                    Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque
                                    porta pulvinar libero
