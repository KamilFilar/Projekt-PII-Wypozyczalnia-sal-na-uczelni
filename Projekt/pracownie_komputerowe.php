...
<head>
    ...
    <!-- Title -->
    <title>Pracownie komputerowe</title>
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10">
                        ...
                        <div class="Title_of_Page">Pracownie komputerowe</div>
                            ...
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS/Sale_komputerowe/komp1.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Pracownia komputerowa, A2 s.300</b> </div></br>
                                        <div class="Number"><b>Maksymalna ilosc miejsc:</b> 30</div></br>
                    ...
                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="row justify-content-center">
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS/Sale_komputerowe/komp2.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Pracownie komputerowe, A3 s.254</b> </div></br>
                                        <div class="Number"><b>Maksymalna ilosc miejsc:</b> 40</div></br>
                                        <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                            Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque
                                            porta pulvinar libero
                    ...
                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row justify-content-center">
                            <div class="col col-xl-10 col-lg-10 col-md-10 col-sm-10 NiceBorder">
                                <div class="row">
                                    <div class="col col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                        <img src="./CSS/Sale_komputerowe/komp3.jpg" class="IMG" />
                                    </div>
                                    <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        </br>
                                        <div class="Subtitle"><b>Pracownie komputerowe, A1 s.75</b> </div></br>
                                        <div class="Number"><b>Maksymalna ilosc miejsc:</b> 50</div></br>
                                        <div class="About_Room"><b>Opis:</b> Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                            Justo in odio elit et tincidunt. Id in tellus tempus diam. Non tristique scelerisque
                                            porta pulvinar libero
